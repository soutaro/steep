...
class Array<'a>
  ...
  def test_variable_elimination
    ...
    assert_equal AST::Types::Name::Instance.new(name: ModuleName.parse("::String"), args: [AST::Types::Any.new]),
                 constraints.eliminate_variable(AST::Types::Name::Instance.new(name: ModuleName.parse("::String"),
