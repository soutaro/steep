...
class MethodParsingTest < Minitest::Test
  ...
  def test_required_params
    ...
    assert_equal [T::Any.new, T::Name.new(name: :String)], method.params.required
    assert_equal [], method.params.optional
    assert_nil method.params.rest
    assert_equal({}, method.params.required_keywords)
    assert_equal({}, method.params.optional_keywords)
  ...
  def test_optional_params1
    ...
    assert_equal [T::Any.new, T::Name.new(name: :Integer)], method.params.required
    assert_equal [T::Name.new(name: :String)], method.params.optional
    assert_nil method.params.rest
    assert_equal({}, method.params.required_keywords)
    assert_equal({}, method.params.optional_keywords)
    assert_nil method.params.rest_keywords
  ...
  def test_optional_params2
    method = Steep::Parser.parse_method("(?any, ?String) -> any")
    assert_equal [], method.params.required
    assert_equal [T::Any.new, T::Name.new(name: :String)], method.params.optional
    assert_nil method.params.rest
    assert_equal({}, method.params.required_keywords)
    assert_equal({}, method.params.optional_keywords)
    assert_nil method.params.rest_keywords
  ...
  def test_rest_param
    ...
    assert_equal [T::Name.new(name: :String)], method.params.optional
    assert_equal T::Name.new(name: :Integer), method.params.rest
    assert_equal({}, method.params.required_keywords)
    assert_equal({}, method.params.optional_keywords)
    assert_nil method.params.rest_keywords
    assert_nil method.block
  ...
  def test_keywords
    ...
    assert_equal [T::Name.new(name: :String)], method.params.optional
    assert_equal T::Name.new(name: :Integer), method.params.rest
    assert_equal({ name: T::Name.new(name: :String) }, method.params.required_keywords)
    assert_equal({ email: T::Name.new(name: :Symbol)}, method.params.optional_keywords)
    assert_nil method.params.rest_keywords
    assert_nil method.block
    assert_equal T::Any.new, method.return_type
  end
  ...
  def test_rest_keywords
    ...
    assert_equal({ name: T::Name.new(name: :String) }, method.params.required_keywords)
    assert_equal({ email: T::Name.new(name: :Symbol)}, method.params.optional_keywords)
    assert_equal T::Name.new(name: :Integer), method.params.rest_keywords
    assert_nil method.block
    assert_equal T::Any.new, method.return_type
  end
  ...
  def test_block1
    ...
    assert_equal({}, method.block.params.optional_keywords)
    assert_nil method.block.params.rest_keywords
    assert_equal T::Name.new(name: :String), method.block.return_type
    assert_equal T::Any.new, method.return_type
  end
  ...
  def test_block2
    ...
    assert_equal T::Name.new(name: :Integer), method.params.rest_keywords
    assert_instance_of T::Interface::Block, method.block
    assert_equal [T::Name.new(name: :String)], method.block.params.required
    assert_equal [T::Name.new(name: :Integer)], method.block.params.optional
    assert_equal T::Name.new(name: :Symbol), method.block.params.rest
    assert_equal({}, method.block.params.required_keywords)
    assert_equal({}, method.block.params.optional_keywords)
    assert_nil method.block.params.rest_keywords
    assert_equal T::Any.new, method.block.return_type
