...
class Steep::Server::LSPFormatterTest < Minitest::Test
  ...
  def type_check(content)
    ...
    Services::TypeCheckService.type_check(source: source, subtyping: subtyping, constant_resolver: resolver, cursor: nil, contracts: Steep::Contracts::Store.empty, postconditions: Steep::Postconditions::Store.empty, callbacks: Steep::Callbacks::Store.empty, delegation_registry: Steep::Project::DelegationRegistry.new)
  end
