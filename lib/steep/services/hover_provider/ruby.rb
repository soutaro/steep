    ...
    module HoverProvider
      ...
      class Ruby
        ...
        def typecheck(target, path:, content:, line:, column:)
          ...
          [
            Services::TypeCheckService.type_check(source: source, subtyping: subtyping, constant_resolver: resolver, cursor: pos, contracts: project.contracts, postconditions: project.postconditions),
            subtyping
          ]
        rescue
          nil
